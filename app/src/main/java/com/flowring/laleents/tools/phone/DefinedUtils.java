...
public class DefinedUtils {
    ...
    public static final int REQUEST_CHATROOM = 0x12;
    public static final int REQUEST_SCAN_QRCODE = 0x13;
    public static final int REQUEST_MENU_MEDIA = 0x14;
    public static final int REQUEST_MENU_CAMERA = 0x15;
    public static final int REQUEST_LOCATION = 0x16;
    public static final int REQUEST_MAP_MARKED = 0x17;
    public static final int REQUEST_SEARCH = 0x18;
    public static final int REQUEST_VIDEO_CALLING = 0x19;
    public static final int REQUEST_VOICE_CALLING = 0x20;
    public static final int REQUEST_CHOOSE_PHOTO = 0x21;
    public static final int REQUEST_LALETON_CARD = 0x22;
    public static final int REQUEST_CREATE_GROUP = 0x23;
    public static final int REQUEST_MODIFY_MEMBER = 0x24;
    public static final int REQUEST_ROOM_SETTING = 0x25;
    public static final int REQUEST_SET_PASSWORD = 0x26;
    public static final int REQUEST_PROFILE_CAMERA = 0x27;
    public static final int REQUEST_CHOOSE_FILE = 0x28;
    public static final int REQUEST_FORWARD_MESSAGE = 0x29;
    public static final int REQUEST_CHOOSE_CONTACT = 0x30;
    public static final int REQUEST_IMAGE_PICKER = 0x31;
    public static final int REQUEST_SCAN_FORM_WEB = 0x32;
    public static final int REQUEST_MANAGE_STICKER = 0x34;
    public static final int REQUEST_PREVIEW_CARD = 0x35;
    public static final int REQUEST_SCAN_DOMAIN = 0x36;
    public static final int REQUEST_CARD_CAMERA = 0x37;
    public static final int REQUEST_CHROME_TAB = 0x38;
    public static final int REQUEST_ZOOM_IMAGE = 0x39;
    public static final int REQUEST_LALE_APP = 0x40;
    public static final int REQUEST_MY_COLLECT = 0x41;
    public static final int REQUEST_COLLECT_FUNCTION = 0x42;
    public static final int REQUEST_OPEN_NEW = 0x43;
    public static final int REQUEST_FRIEND_CONTENT = 0x44;
    public static final int REQUEST_BUSINESS_CARD = 0x45;
    public static final int REQUEST_COMPANY_TAB = 0x46;
    public static final int REQUEST_SPEECH_TO_TEXT = 0x47;
//    public static final int REQUEST_CROP_PHOTO    = 0x33;
    ...
    public static final int MSG_STATE_IMAGE_IN = 3;
    public static final int MSG_STATE_IMAGE_OUT = 4;
    public static final int MSG_STATE_VIDEO_IN = 5;
    public static final int MSG_STATE_VIDEO_OUT = 6;
    public static final int MSG_STATE_LOCATION_IN = 7;
    public static final int MSG_STATE_LOCATION_OUT = 8;
    public static final int MSG_STATE_VOICE_IN = 9;
    public static final int MSG_STATE_VOICE_OUT = 10;
